...
namespace CandidateManagement_BussinessObject;
...
public partial class CandidateManagementContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CandidateId).HasName("PK__Candidat__DF539BFCDFED4C87");
        ...
        {
            entity.HasKey(e => e.Email).HasName("PK__HRAccoun__A9D105358EE10B07");
        ...
        {
            entity.HasKey(e => e.PostingId).HasName("PK__JobPosti__C31796A55D47B331");
